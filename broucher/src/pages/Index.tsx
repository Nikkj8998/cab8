...
const CybersecurityCTAPage = () => (
  <section className="page min-h-screen flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 py-12 bg-white">
    <div className="text-center max-w-4xl">

      {/* ✅ Logo component - white bg so no variant needed */}
      <Logo className="mb-6 md:mb-8 scale-90 md:scale-100 lg:scale-110" />

      <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-gray-900">
        Ready to Secure Your Business?
      </h2>

      <button className="px-6 py-3 bg-primary text-white rounded-full text-base md:text-lg font-semibold inline-flex items-center gap-2">
