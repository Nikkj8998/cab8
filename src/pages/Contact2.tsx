...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Call Us",
      details: ["Call Us for Business:", "+91-9028541383", "020 2069010200", "Call us for Career and Support: +91 8484815905"],
    },
    {
      icon: Mail,
      title: "Email Us",
  ...
  const offices = [
    {
      ...
      phone: ["+91-8530171515 | ", "+91-9028541383", "020 2069010200"],
